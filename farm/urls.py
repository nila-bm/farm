...
from .views import FarmListView,FarmHome,FarmDetailView,FarmCreateView,FarmUpdateView,FarmDeleteView
...
urlpatterns = [
    ...
    path("<int:pk>/delete/",FarmDeleteView.as_view(),name="farmdelete")
